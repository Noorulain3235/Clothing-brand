...
export default function Background4() {
    return (
        ...
        <div className=" w-full h-[500px] md:h-[550px] lg:h-[600px] sticky top-0 z-0">
            ...
            <div className="absolute inset-0 flex items-center justify-center md:justify-end text-center
             md:text-start text-white px-4">
                <div className=" w-[90%] md:w-[50%] flex flex-col ">
                    ...
                    <Link
                        to="/"
                        className="block mt-5 font-semibold md:font-medium w-[120px] md:w-[170px]
                     text-sm text-center bg-transparent border border-white ml-10 md:ml-0
